...
for i in range(0,len(cols)):
    ...
    for j in range(winterIntervalRange[0],endYear):
        #if(j > winterBreak[0] and excludeWinterBreak == True):#Ignores Winter Break
         #   winterRow.append(nan)
          #  continue
        #else:
        winterRow.append(df.at[j,cols[i]])
    for n in range(0,winterIntervalRange[1]):
        #if(n < winterBreak[1] and excludeWinterBreak == True):#Ignores Winter Break
         #   winterRow.append(nan)
          #  continue
        #else:
